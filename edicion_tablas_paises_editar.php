...
{
	$tabla->deletePais($_POST['ID'],'img/banderas/'.$_POST['FICHERO']);
...
elseif ($_POST['OPERACION'] == 'MODIF')
{
	...
	$tabla->setPais($_POST['ID'], $_POST['ID2'],$_POST['DESCRIPCION'],$FICHERO,$_POST['NUM_PAIS'] );
...
{
	$id = $tabla->newPais($_POST['ID2'],$_POST['DESCRIPCION'],$_FILES["fileToUpload"]["name"],$_POST['NUM_PAIS']);
...
?>
  ...
  <div class="container"> 
      <div class="row">
            <div class="col-lg-12">
			     <div class="page-header">
			        ...
			        <ol class="breadcrumb">
				     ...
				     <li class="active"><a href="edicion_tablas_paises.php"><i class="fa fa-fw fa fa-map"></i> Paises</a></li>
				     <?php
		...
		<form class="form-horizontal" name="tabla" method="POST" action="edicion_tablas_paises_editar.php" enctype="multipart/form-data">
		    ...
		    <div class="form-group">
		        <label class="control-label col-xs-3">ID2:</label>
		        <div class="col-xs-9">
		            <input type="text" class="form-control" id="ID2" placeholder="Identificador" name="ID2" value='<?php echo $id2; 	?>'>
		        </div>
		    </div> 		    
	    <div class="form-group">
	    ...
	    <div class="form-group">
	        <label class="control-label col-xs-3">Nivel país:</label>
	        <div class="col-xs-9">
	        	<select name="NUM_PAIS" id="NUM_PAIS" class="form-control" >
	        	<?php
	        	  for ($fila = 1; $fila <= 4; $fila ++)
	        	  {
	        	  	if ($num_pais == $fila) 
	        	  	{
	        	  		echo '<option selected value="'.$fila.'">Nivel '.$fila.'</option>';
	        	  	}
	        	  	else
	        	  	{
	        	  		echo '<option value="'.$fila.'">Nivel '.$fila.'</option>';
	        	  	}
	        	  } 
	        	?>
		        </select>
	    ...
	    <div class="form-group">
	        ...
	        <?php 
	        if (!empty($fichero))
	        	echo ' <img class="img-thumbnail" width="55" height="33" src="img/banderas/'.$fichero.'" >';
	        ?>
	        </div>
	        <div class="col-xs-6">
