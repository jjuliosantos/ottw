...
$idmoto = $generales->verificaVariable($_GET['idmoto']);
 ...
 $rs = $motoDetalle->getMotoDetalleWEB($where);
 $row = $rs->fetch_assoc();
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-fw fa fa-file-text"></i> <?php echo $marca; ?></li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-12">
				...
				<dl class="dl-horizontal">
					...
					<dd>
						...
						if (!empty($ingeniero)){
							echo "<dt>Ingeniero/Diseñador:</dt><dd>";
							echo $ingeniero;
							echo "</dd>";
						}
					?>
            ...
            <?php
            	...
            	if ($rs->num_rows > 0){
            		...
            		while ($rowEscuter = $rs->fetch_assoc()) {
            			if($fila==1){
            				echo '<div class="row"><div class="col-lg-12"><h3 class="page-header">Escúter</h3></div>';
            			}
            			elseif (($fila - 1) % 4 == 0){
            				echo '</div><div class="row">';
            			}
            			...
            			echo '<a href="img/escuter/'.$rowEscuter["FICHERO"].'" data-toggle="lightbox" data-gallery="Escúter" data-title="Escúter">';
