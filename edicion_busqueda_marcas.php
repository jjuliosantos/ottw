...
$marca = new Marca();
$rs = $marca->getMarcaNOWEB($where);
$totalPaginacion = $rs->num_rows;

$limit = "LIMIT $from, $cantidad";
$rs = $marca->getMarcaNOWEB($where, $limit);
...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-header"><h1>Mantenimiento OTTW</h1>
                </div>
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="#" onclick="document.getElementById('busqueda').value='';document.getElementById('SESSION').value='RESET';document.filtro.action='edicion_busqueda_marcas.php';document.filtro.submit();"><i class="fa fa-fw fa fa-binoculars"></i> Consultas</a></li>
                    <?php 
                    	if (!empty($letra)){
        ...
        <div class="row">
            <div class="col-lg-4">
					<form class="form-inline" id="filtro" name="filtro" role="search" action="edicion_busqueda_marcas.php" method="post">
  ...
  <thead>
    ...
    <tbody data-link="row" class="rowlink">
		...
		while ($row = $rs->fetch_assoc()) {
			...
			$anyo	= $row['ANY'];
		?>
		<tr role="button" onclick="window.document.location='edicion_portfolio-item.php?idmoto=<?php echo $idmoto; ?>';">
		...
		<hr>
		<?php
			$url = "edicion_busqueda_marcas.php?";
