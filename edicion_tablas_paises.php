...
$tabla = new Tabla();
$rs = $tabla->getPaisesTodos();
$totalPaginacion = $rs->num_rows;

$limit = "LIMIT $from, $cantidad";
$rs = $tabla->getPaisesTodos($limit);
            ...
            <div class="col-lg-12">
			     <div class="page-header">
			        ...
			        <ol class="breadcrumb">
				     ...
				     <li class="active"><i class="fa fa-fw fa fa-map"></i><?php echo ' '.number_format($totalPaginacion,0,',','.'); ?> Países</li>
			        </ol>
			      </div>
            </div>
        </div>
        <!-- /.row -->
        <form class="form-horizontal" name="tabla" method="POST" action="edicion_tablas_paises_editar.php">
        <div class="row">
