...
{
	$tabla->deleteEscudo($_POST['ID'],'img/escudos/'.$_POST['FICHERO']);
...
elseif ($_POST['OPERACION'] == 'MODIF')
{
	...
	$tabla->setEscudo($_POST['ID'], $_POST['DESCRIPCION'],$FICHERO );
...
{
	$id = $tabla->newEscudo($_POST['DESCRIPCION'],$_FILES["fileToUpload"]["name"]);

	$mensaje = $mensaje."Registro actualizado";
	$operacion = 'PRE-MODIF';
}

	$rs = $tabla->getEscudo($id);
...
?>
  ...
  <div class="container"> 
      <div class="row">
            <div class="col-lg-12">
			     <div class="page-header">
			        ...
			        <ol class="breadcrumb">
				     ...
				     <li class="active"><a href="edicion_tablas_escudos.php"><i class="fa fa-fw fa fa-shield"></i> Escudos</a></li>
				     <?php
		...
		<form class="form-horizontal" name="tabla" method="POST" action="edicion_tablas_escudos_editar.php" enctype="multipart/form-data">
	    ...
	    <div class="form-group">
	        ...
	        <?php 
	        if (!empty($fichero))
	        	echo ' <img class="img-thumbnail" width="55" height="33" src="img/escudos/'.$fichero.'" >';
	        ?>
	        </div>
	        <div class="col-xs-6">
