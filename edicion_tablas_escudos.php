...
?>
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
			     <div class="page-header">
			        ...
			        <ol class="breadcrumb">
				     ...
				     <li class="active"><i class="fa fa-fw fa fa-shield"></i><?php echo ' '.number_format($totalPaginacion,0,',','.'); ?> Escudos</li>
			        </ol>
			      </div>
            </div>
        </div>
        <!-- /.row -->
        <form class="form-horizontal" name="tabla" method="POST" action="edicion_tablas_escudos_editar.php">
        <div class="row">
		...
		<?php
     		$url = "edicion_tablas_escudos.php?";
